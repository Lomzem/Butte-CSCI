...
// {
//     // need to do -- because we start counting from 1
//     choice1--;
//     choice2--;
...
//     }
// }
Animal determineWinner(array<Animal, 5> &animals, int index1, int index2) {
    // need to do -- because we start counting from 1
    index1--;
    index2--;
    Animal animal1 = animals.at(index1);
    Animal animal2 = animals.at(index2);

    int animal1score = animal1.Strength + animal1.Toughness;
    int animal2score = animal2.Strength + animal2.Toughness;

    if (animal1score < animal2score) {
        animal1score += animal1.Luck;
    } else if (animal1score > animal2score) {
        animal2score += animal2.Luck;
    } else {
        animal1score += animal1.Luck;
        animal2score += animal2.Luck;
    }
    ...
    // TODO! Handle what happens if they have the same score
    if (animal1score > animal2score) {
        return animals.at(index1);
    } else {
        return animals.at(index2);
    }
}
